...
This document describes the high level design details of and its components. The core file manager document consists of core file generation framework and exporting the support save data to remote server. The framework consists is normal sy of generic device drivers and user space platform API plugins which use the per platform specific data in the JSON descriptor files. This document describes the interaction between all the components and the tools used to support these drivers and plugins.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcyOTg5OTM5NSwtMTE2NDY0NDA2LC00MD
